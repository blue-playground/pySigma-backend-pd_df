...
# DONE: implement tests for some basic queries and their expected results.
# def test_pd_df_and_expression_pdninja(pd_df_backend: PandasDataFramePythonBackend):
#     assert (
#         pd_df_backend.convert(
#             SigmaCollection.from_yaml(
#                 """
...
# def test_pd_df_or_expression_pdninja(pd_df_backend: PandasDataFramePythonBackend):
#     assert (
#         pd_df_backend.convert(
#             SigmaCollection.from_yaml(
#                 """

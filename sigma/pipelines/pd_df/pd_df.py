...
@Pipeline
def pd_df_pipeline() -> ProcessingPipeline:        # Processing pipelines should be defined as functions that return a ProcessingPipeline object.
    return ProcessingPipeline(
        name="Pandas DataFrame Python example pipeline",
        ...
        items=[
            ProcessingItem(     # This is an example for processing items generated from the mapping above.
                identifier=f"pd_df_windows_{service}",
            ...
            ProcessingItem(     # Field mappings
                identifier="pd_df_field_mapping",
